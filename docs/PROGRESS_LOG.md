...
- Then: v1.0.0 release (bump → PR → merge → rebuilt assets → final silent install/launch/uninstall validation → tag → GitHub release) + repo description/topics. **Project complete; further work optional.**
